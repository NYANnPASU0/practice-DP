...
public:
    ...
    void next()
    {
        ...
        {
            int max_j = -1;//max_j, который указывает на самый правый элемент, значение которого больше значения элемента с индексом k
    ...
    void previous()
    {
        ...
        {
            int max_j = -1;//max_j, который указывает на самый правый элемент, значение которого меньше значения элемента с индексом max_i
            for (int i = size - 1; i > max_i; i--)
            {
                if (perm[i] < perm[max_i])
                {
